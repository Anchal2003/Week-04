...
public class CountWordsInFile {
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\hp\\IdeaProjects\\JavaStreams\\src\\main\\java\\com\\javastream\\day03\\sample.txt";

        //Create a map to store the result
        Map<String, Integer> wordCounts = WordCount.countWordsInFile(filePath);

        //Create a list to store the result
        List<String> topWords = WordCount.findTopWords(wordCounts, 5);
