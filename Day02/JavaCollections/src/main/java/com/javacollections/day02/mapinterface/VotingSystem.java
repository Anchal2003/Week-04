...
class Voting{
    ...
    //Create a method displayVotesInOrder to display votes in order
    ...
    //Create a method to display sorted votes
...
public class VotingSystem {
    ...
    public static void main(String[] args) {
        ...
        voter.displayVotesInOrder();

        //call the method and print the result
        System.out.println("\nResults Sorted by Votes:");
        voter.displaySortedVotes();
    }
}
