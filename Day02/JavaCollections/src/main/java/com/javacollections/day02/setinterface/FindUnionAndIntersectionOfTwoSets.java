...
import  java.util.*;
//Create a class to find the union and intersection of sets
...
//Create a class FindUnionAndIntersectionOfTwoSets
public class FindUnionAndIntersectionOfTwoSets {
